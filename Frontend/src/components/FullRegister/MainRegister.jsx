...
function MainRegister() {
  ...
  const handlePincodeChangeadd1 = (e) => {
    ...
    axios
      .get(`http://localhost:3010/users/getStateById/${inputPincode}`)
      .then((response) => {
        if (response.data.success) {
          console.log("check data pincode", response.data.data[0].pincode);
          setFormData({
            ...formData,
            address: `${response.data.data[0].pincode}, ${response.data.data[0].cityname}, ${response.data.data[0].statename}`,
          });
        } else {
          setFormData({
            ...formData,
    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          ...
          setFormData({
            ...formData,
            birthPlace: `${response.data.data[0].pincode}, ${response.data.data[0].cityname}, ${response.data.data[0].statename}`,
          });
        } else {
          setFormData({
            ...formData,
    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          ...
          setFormData({
            ...formData,
            workPlace: `${response.data.data[0].pincode}, ${response.data.data[0].cityname}, ${response.data.data[0].statename}`,
          });
        } else {
          setFormData({
            ...formData,
    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          ...
          setFormData({
            ...formData,
            familyAddress: `${response.data.data[0].pincode}, ${response.data.data[0].cityname}, ${response.data.data[0].statename}`,
          });
        } else {
          setFormData({
            ...formData,
  ...
  //   console.log("test ing data file ",file)
  ...
  //   const {name}=e.target;
  //   console.log("check image",e,e.target.files[0],name)
  ...
  const handleSubmit = (e) => {
    ...
    if (validateStep(step)) {
      ...
      console.log("check 2 ", formData)

      setStep(1);
      axios.post(`http://localhost:3010/users/insertporfile/${userDetails.user_id}`, formData)
        .then(response => {
              ...
              <div className="d-lg-flex justify-content-between ">
                <div className="mb-2 mt-5 col-xxl-5 ">
                  ...
                  <input
                    ...
                    value={formData.candidateIncome}
                    onChange={handleChange}
            ...
            <div className="summary mt-5">
              ...
              <div className="mb-5">
                <div className="lastimg text-center mb-5">
                  <img className="w-75" src="./image/user_images.jpg" />
                  {/* image logic */}
                </div>
              ...
              <div className="d-flex mt-5 mb-5 align-item-center gap-3 justify-content-between">
                ...
                <div className="family-detail-box ">
                  ...
                  <ul className="ms-5">
                    ...
                    <li>Goverment ID: {formData.govt_id}</li> */}
                  </ul>
                </div>
              </div>
          ...
          {step === 6 && (
            <div>
              <div className="payment mt-5 mb-5">
                <Pay name={formData.name} dob={formData.dob} />
              </div>
