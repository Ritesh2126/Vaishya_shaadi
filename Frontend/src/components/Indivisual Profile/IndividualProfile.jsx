...
function IndividualProfile() {
  ...
  return (
    <>
      ...
      <div className="mycontainer"> {errors}
      {cards.length > 0 && (
        <div  className=" mt-5 d-flex singlepro flex-column justify-content-center">
          <h2 className="text-center">Please Check All Details are Corrected.</h2>

          <div className="mb-5">
            <div className="lastimg text-center mb-5">
              <img className="" src={`/images/${cards[0].image}`} alt={cards[0].Name} />
            </div>
            <div className="basic-detail-box">
              <h3>Candidate basic details</h3>
              <ul>
      ...
      {errors && (
        <div className="text-center text-danger mt-3">{errors}</div>
      )}
     </div>
    </>
  );
