                  ...
                  <tbody className="table-group-divider">
                    {userdataArray.map((prev, i) => (
                      <tr key={i}>
                        ...
                        <td className="table-success"><button onClick={()=>deleteuser(prev.user_id)}>Delete</button></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                  ...
                  <tbody className="table-group-divider">
                    {profileappdataArray.map((prev, i) => (
                        <tr key={i}>
                          ...
                          <td className="table-success"><button onClick={()=>checkprodetails2(prev.Pro_id)}>More Details</button></td>
                        </tr>
                      ))}
                  </tbody>
                </table>
                  ...
                  <tbody className="table-group-divider">
                    {profilenotappdataArray.map((prev, i) => (
                        <tr key={i}>
                          ...
                          <td className="table-success">{prev.DOB}</td>
                          <td className="table-danger">{prev.Phone_Number}</td>
                          <td className="table-success"><button onClick={()=>checkprodetails(prev.Pro_id)}>More Details</button></td>
                          <td className="table-success"><button onClick={()=>approveprodetails(prev.Pro_id)}>Approved</button><br></br>
                          <br></br><button onClick={()=>deleteprodetails(prev.Pro_id)}>Delete</button></td>
                        </tr>
                      ))}
                  </tbody>
                </table>
